...
import { NxDBUpdatePlugin } from '../../plugins/update/index.mjs';
addRxPlugin(NxDBUpdatePlugin);
import { NxDBMigrationPlugin } from '../../plugins/migration-schema/index.mjs';
    ...
    describe('instance', () => {
        describeParallel('.insert()', () => {
            ...
            describe('negative', () => {
                ...
                /**
                 * @link https://github.com/nxpkg/nxdb/issues/5046
                 */
        ...
        describe('.find()', () => {
            ...
            describeParallel('.regex()', () => {
                ...
                describe('negative', () => {
                    /**
                     * Disallowed since NxDB version 15.
            ...
            describeParallel('.remove()', () => {
                ...
                /**
                 * @link https://github.com/nxpkg/nxdb/pull/3785
                 */
                ...
                /**
                 * @link https://github.com/nxpkg/nxdb/pull/3788
                 */
        ...
        describeParallel('.count()', () => {
            ...
            /**
             * @link https://github.com/nxpkg/nxdb/pull/4775
             */
        ...
        describeParallel('.findByIds()', () => {
            ...
            /**
             * @link https://github.com/nxpkg/nxdb/issues/6148
             */
