...
describeParallel('rx-schema.test.ts', () => {
    describe('static', () => {
        ...
        describe('.checkSchema()', () => {
            ...
            describe('negative', () => {
                ...
                /**
                 * @link https://github.com/nxpkg/nxdb/issues/4926#issuecomment-1712223984
                 */
        ...
        describe('.fillWithDefaultSettings() / .normalizeRxJsonSchema()', () => {
            ...
            it('should not sort indexes array in the schema (related with https://github.com/nxpkg/nxdb/pull/1695#issuecomment-554636433)', () => {
    ...
    describe('instance', () => {
        ...
        describe('.hash', () => {
            describe('positive', () => {
                 ...
                 * @link https://github.com/nxpkg/nxdb/pull/4005
                 */
    ...
    describe('issues', () => {
        ...
        /**
         * @link https://github.com/nxpkg/nxdb/issues/3994#issuecomment-1260073490
         */
