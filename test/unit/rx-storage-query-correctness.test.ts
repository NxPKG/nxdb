...
describeParallel('rx-storage-query-correctness.test.ts', () => {
    type TestCorrectQueriesInput<RxDocType> = {
        ...
        queries: ({
             ...
             * of the NxDB query planner to have
    ...
    testCorrectQueries<HumanDocumentType>({
        ...
        queries: [
            ...
            {
                /**
                 * @link https://github.com/nxpkg/nxdb/pull/4751
                 */
    ...
    /**
     * @link https://github.com/nxpkg/nxdb/issues/4571
     */
    testCorrectQueries({
    ...
    /**
     * @link https://github.com/nxpkg/nxdb/issues/5273
     */
    testCorrectQueries<{
        id: string;
