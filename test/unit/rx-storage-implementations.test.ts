...
import { NxDBQueryBuilderPlugin } from '../../plugins/query-builder/index.mjs';
    ...
    describe('RxStorageInstance', () => {
        ...
        describe('.bulkWrite()', () => {
            ...
            it('should NOT be able to overwrite a deleted the document', async () => {
                 ...
                 * In contrast, NxDB itself will allow to re-insert an already deleted RxDocument.
                 */
             ...
             * @link https://github.com/nxpkg/nxdb/pull/3734
             */
        ...
        describe('.query()', () => {
             ...
             * filtering out deleted documents is done by NxDB, not by the storage.
             */
            ...
            it('should have the same deterministic order of .query() and .getSortComparator()', async () => {
                const schema: RxJsonSchema<RxDocumentData<RandomDoc>> = fillWithDefaultSettings({
                    ...
                    indexes: [
                        /**
                         * NxDB will always append the primaryKey to an index
                ...
                const queries: FilledMangoQuery<RandomDoc>[] = [
                    ...
                    },
                    {
                        ...
                        sort: [
                            { equal: 'asc' },
                            /**
                             * NxDB will always append the primaryKey as last sort parameter
