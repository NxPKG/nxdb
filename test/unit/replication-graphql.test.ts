...
describe('replication-graphql.test.ts', () => {
    ...
    const pullQueryBuilder = (checkpoint: any, limit: number) => {
        ...
        const query = `query FeedForNxDBReplication($checkpoint: CheckpointInput, $limit: Int!) {
            feedForNxDBReplication(checkpoint: $checkpoint, limit: $limit) {
                documents {
                    id
                    name
                    age
        ...
        return Promise.resolve({
            query,
            operationName: 'FeedForNxDBReplication',
            variables
        });
    };
    ...
    describe('node', () => {
        ...
        describeParallel('live:false pull only', () => {
            ...
            it('should pull documents from a custom dataPath if one is specified', async () => {
                ...
                const collectionQueryBuilder = (checkpoint: any, limit: number) => {
                    ...
                    {
                        collectionFeedForNxDBReplication(checkpoint: $checkpoint, limit: $limit) {
                            collection {
                                documents {
                                    id
                                    name
                ...
                const replicationState = replicateGraphQL({
                    ...
                    pull: {
                        ...
                        dataPath: 'data.collectionFeedForNxDBReplication.collection'
                    },
                    deletedField: 'deleted'
                });
                ensureReplicationHasNoErrors(replicationState);
            ...
            /**
             * @link https://github.com/nxpkg/nxdb/pull/3644
             */
            ...
            // https://github.com/nxpkg/nxdb/blob/d7c3aca4f49d605ceae8997df32f713d0fe21ee2/src/types/plugins/replication.d.ts#L47-L53
        ...
        describeParallel('issues', () => {
            ...
            /**
             * @link https://github.com/nxpkg/nxdb/pull/5259#discussion_r1396062635
             */
