...
import { NxDBLeaderElectionPlugin } from '../../plugins/leader-election/index.mjs';
import { NxDBLocalDocumentsPlugin } from '../../plugins/local-documents/index.mjs';
...
describe('rx-storage-lokijs.test.js', () => {
    ...
    describeParallel('issues', () => {
         ...
         *
         * @link https://github.com/nxpkg/nxdb/issues/3666#issuecomment-1027801805
         */
        describe('#3666 NxDB with lokijs works bad in Safari and FF when using multiple tabs', () => {
