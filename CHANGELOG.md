...
- ADD [Fulltext Search Plugin](https://nxpkg.github.io/nxdb/fulltext-search.html)
...
- ADD [RxPipeline Plugin](https://nxpkg.github.io/nxdb/rx-pipeline.html).
- FIX (denoKV RxStorage) retry writes when db is locked.

### 15.30.2 (5 August 2024)

- FIX `node:sqlite` couldn't be found in react native [#6291](https://github.com/nxpkg/nxdb/issues/6291)
...
- FIX key-compression broken with boolean indexes on dexie [#6267](https://github.com/nxpkg/nxdb/pull/6267)
- FIX type of `RxQuery.$` must be `Observable` [#6285](https://github.com/nxpkg/nxdb/issues/6285)
...
- ADD storage bucket support to the [IndexedDB RxStorage](https://nxpkg.github.io/nxdb/rx-storage-indexeddb.html).
...
- FIX Wrong Reactivity generics passed by RxCollection extending RxCollectionBase [#6188](https://github.com/nxpkg/nxdb/issues/6188)
...
- FIX Query Builder does not work on queries created by `.findByIds()` [#6148](https://github.com/nxpkg/nxdb/issues/6148)
- FIX (IndexedDB RxStorage) When used with Sharding and Workers, it sometimes errors on the first query after db creation.

### 15.24.0 (9 June 2024)

- Opened the [NxDB User Survey 2024](https://nxpkg.github.io/nxdb/survey)
- FIX rx-state multi instance observable broken [#6084](https://github.com/nxpkg/nxdb/pull/6084)

### 15.23.0 (29 May 2024)

- FIX type resolving in webpack [#6051](https://github.com/nxpkg/nxdb/pull/6051)

### 15.22.0 (23 May 2024)

- Add missing extensions error field to errorToPlainJson [#6029](https://github.com/nxpkg/nxdb/pull/6029)
- ADD dedicated [errors page](https://nxpkg.github.io/nxdb/errors.html)
- FIX randomly failing replication test
- ADD non-premium console.log on the [LokiJS RxStorage](https://nxpkg.github.io/nxdb/rx-storage-lokijs.html#disabling-the-non-premium-console-log)
...
- IMPROVE performance of insert to [IndexedDB](https://nxpkg.github.io/nxdb/rx-storage-indexeddb.html)
- ADD non-premium console.log on the [Dexie.js RxStorage](https://nxpkg.github.io/nxdb/rx-storage-dexie.html#disabling-the-non-premium-console-log)
...
- ADD(GraphQL replication) change GraphQL query builder functions to generate output fields for nested queries [#5976](https://github.com/nxpkg/nxdb/pull/5976)
...
- ADD the new [Memory-Mapped RxStorage](https://nxpkg.github.io/nxdb/rx-storage-memory-mapped.html), a better alternative for the Memory-Synced RxStorage.
...
- RxServer: `updatedAt` must be `lwt` [#61](https://github.com/nxpkg/nxdb-server/pull/61)
- RxServer: Fix using `parseFloat` instead of `parseInt` [#5883](https://github.com/nxpkg/nxdb/issues/5883)
...
- FIX vite bundling error with WebRTC replication [#5841](https://github.com/nxpkg/nxdb/issues/5841)
- ADD replication-webrtc: allow passing config to simple-peer [#5838](https://github.com/nxpkg/nxdb/pull/5838)
...
- ADD `PreactSignalsRxReactivityFactory` to use [custom reactivity](https://nxpkg.github.io/nxdb/reactivity.html) with **preact signals** instead of observables.
- ADD `VueRxReactivityFactory` to use [custom reactivity](https://nxpkg.github.io/nxdb/reactivity.html) with **vue shallow refs** instead of observables.
- ADD(reactivity) pass reference to `RxDatabase` to `fromObservable()`

### 15.14.0 (25 March 2024)

- ADD [Fastify adapter to RxServer](https://nxpkg.github.io/nxdb/rx-server.html)
- ADD [Koa adapter to RxServer](https://nxpkg.github.io/nxdb/rx-server.html)
...
- [SQLite RxStorage](https://nxpkg.github.io/nxdb/rx-storage-sqlite.html) add support to use Webassembly SQLite in the browser
...
- ADD [RxState](https://nxpkg.github.io/nxdb/rx-state.html): A convenient state library to store, fetch and observe complex json data that is persisted into NxDB.
...
- IMPROVE [OPFS RxStorage](https://nxpkg.github.io/nxdb/rx-storage-opfs.html) performance.
- ADD `usesRxDatabaseInWorker` option to the [OPFS RxStorage](https://nxpkg.github.io/nxdb/rx-storage-opfs.html).
...
- FIX [#5624](https://github.com/nxpkg/nxdb/issues/5624) Maximum call stack size exceeded during encryptString

### 15.8.0 (10 February 2024)

- ADD support for [custom reactivity factories](https://nxpkg.github.io/nxdb/reactivity.html) like angular signals or vue template refs.

### 15.7.0 (7 February 2024)

- FIX key-compression broken on keys with brackets [#5605](https://github.com/nxpkg/nxdb/issues/5605)
...
- FIX firestore replication not working with schema validation [#5572](https://github.com/nxpkg/nxdb/issues/5572)
- FIX Replication observation mode ignored when push handler is waiting [#5571](https://github.com/nxpkg/nxdb/issues/5571)
- FIX migration from v14 -> v15 is broken when IndexedDB is used inside of worker. [5565](https://github.com/nxpkg/nxdb/issues/5565)

### 15.5.0 (30 January 2024)

- ADD [RxServer](https://nxpkg.github.io/nxdb/rx-server.html) 🎉
...
- ADD tutorial on [how to start a HTTP replication with a custom server](https://nxpkg.github.io/nxdb/replication-http.html)
...
- ADD  initialCheckpoint for Couchdb [#5461](https://github.com/nxpkg/nxdb/pull/5461)

### 15.1.0 (2 January 2024)

- Add `operationName` to graphQL requests [#5418](https://github.com/nxpkg/nxdb/pull/5418)
- Custom fetch to support axios for the graphQL replication [#5421](https://github.com/nxpkg/nxdb/pull/5421)
- FIX CRDT not working with undefined fields [#5423](https://github.com/nxpkg/nxdb/pull/5423)

### 15.0.0 (20 December 2023)

🚀 **NxDB v15 is released**

- A list of changes for NxDB v15 can be found [here](https://nxpkg.github.io/nxdb/releases/15.0.0.html)
...
- ADD the [MongoDB RxStorage](https://nxpkg.github.io/nxdb/rx-storage-mongodb.html)

### 14.16.0 (21 August 2023)

- FIX primaryKey with value "constructor", breaks findOne()
- FIX Queries with `$lt` selector on primaryKey broken [#4751](https://github.com/nxpkg/nxdb/pull/4751)
...
- FIX count() is incorrect [#4755](https://github.com/nxpkg/nxdb/issues/4755)
...
- Fix returning deleted items in find queries [#4773](https://github.com/nxpkg/nxdb/pull/4773)

### 14.14.0 (7 June 2023)

- ADD [NATS replication](https://nxpkg.github.io/nxdb/replication-nats.html)

### 14.13.0 (2 June 2023)

- Add new hooks in the replication write [#4754](https://github.com/nxpkg/nxdb/pull/4754)
- REFACTOR(docs) [quickstart page](https://nxpkg.github.io/nxdb/quickstart.html)
- REFACTOR(docs) [landing page](https://nxpkg.github.io/nxdb/)

### 14.12.1 (30 May 2023)

- Fix prevent delete _rev from row.doc [#4752](https://github.com/nxpkg/nxdb/pull/4752)
- IMPROVE landingpage hero section [#4753](https://github.com/nxpkg/nxdb/pull/4753)

### 14.12.0 (23 May 2023)

- FIX(couchdb replication) Retries must respect `retryTime` to not cause the UI to stuck [related #4612](https://github.com/nxpkg/nxdb/pull/4612)
- FIX(OPFS RxStorage) various bugs with umlauts
- REMOVE outdated tests [related #4741](https://github.com/nxpkg/nxdb/pull/4741)
- FIX checkSchema for anyOf and items array [#4741](https://github.com/nxpkg/nxdb/pull/4741)
...
- FIX remove `pouchdb-selector-core` dependency [#4722](https://github.com/nxpkg/nxdb/issues/4722)

### 14.11.0 (26 April 2023)

- ADD Links to [NxDB User Survey 2023](https://nxpkg.github.io/nxdb/survey.html)
- FIX better support for as const schemas [#4686](https://github.com/nxpkg/nxdb/pull/4686)

### 14.10.0 (25 April 2023)

- ADD [Filesystem Node RxStorage](https://nxpkg.github.io/nxdb/rx-storage-filesystem-node.html)

### 14.9.0 (20 April 2023)

- ADD [attachment compression plugin](https://nxpkg.github.io/nxdb/rx-attachment.md#attachment-compression)
...
- FIX(docs) `eventReduce: false` is the default. [#4614](https://github.com/nxpkg/nxdb/pull/4614) You have to manually enable eventReduce.
...
- ADD [OPFS RxStorage](https://nxpkg.github.io/nxdb/rx-storage-opfs.html) for browsers (premium).
...
- ADD Export ReplicationOptions type [#4606](https://github.com/nxpkg/nxdb/pull/4606)
...
- FIX: lost RxDocument in preSave from v14.0.0 [#4581](https://github.com/nxpkg/nxdb/pull/4581)
...
- ADD(replication-firestore): add filtered replication [#4590](https://github.com/nxpkg/nxdb/pull/4590)
- FIX(typescript) schema type not working with readonly array [#4579](https://github.com/nxpkg/nxdb/pull/4579)

### 14.4.0 (24 March 2023)

- FIX multiple problems in the query planner
- ADD 'includeWsHeaders' property for GraphQL replication [#4533](https://github.com/nxpkg/nxdb/pull/4533)
- UPDATE [broadcast-channel](https://github.com/nxpkg/broadcast-channel) to version `5.0.0`
- FIX query-builder copies RxQuery's other param [#4587](https://github.com/nxpkg/nxdb/pull/4587)
...
- FIX RxDocument getter should return the same object on property paths [#4548](https://github.com/nxpkg/nxdb/pull/4548)
...
- ADD(utils) export `NXDB_VERSION` variable.
...
- websocket-replication: pass all websocket options to constructor [#4449](https://github.com/nxpkg/nxdb/pull/4449)
- FIX Firebase Replication Issues [#4405](https://github.com/nxpkg/nxdb/pull/4405)
...
### 14.0.0 (8 February 2023) BREAKING [read the announcement](https://nxpkg.github.io/nxdb/releases/14.0.0.html)
...
- CHANGE Prefix storage plugins with `storage-` like `nxdb/plugins/storage-dexie`.
...
- FIX crash with null in selector [#4369](https://github.com/nxpkg/nxdb/pull/4369)
- FIX storage instances MUST NOT mutate the given database- and collection-name.
- REMOVE deprecated `babel-plugin-transform-async-to-promises` plugin.
- ADD Ability to use a responseModifier for GraphQL push replication [#4385](https://github.com/nxpkg/nxdb/pull/4385)
- FIX Add null check for isRxDocument [#4406](https://github.com/nxpkg/nxdb/pull/4406)

### 13.17.1 (30 December 2022)

- FIX Add missing mingo array operators [#4203](https://github.com/nxpkg/nxdb/pull/4203) Thanks [@swnf](https://github.com/swnf)
...
- ADD [Vite Vanilla Typescript Example](https://github.com/nxpkg/nxdb/tree/master/examples/vite-vanilla-ts) Thanks [@SebasG22](https://github.com/SebasG22)
- ADD [Use exports field in package.json](https://github.com/nxpkg/nxdb/pull/4196) Thanks [@SebasG22](https://github.com/SebasG22) and [@swnf](https://github.com/swnf)

### 13.15.3 (13 December 2022)

- ADD `$regex` support to the [SQLite RxStorage](https://nxpkg.github.io/nxdb/rx-storage-sqlite.html)
...
- ADD [SharedWorker RxStorage Plugin](https://nxpkg.github.io/nxdb/rx-storage-shared-worker.html)
...
- ADD [Remote RxStorage Plugin](https://nxpkg.github.io/nxdb/rx-storage-remote.html)
...
- ADD [Firestore Replication Plugin](https://nxpkg.github.io/nxdb/replication-firestore.html)
...
- Deprecated the PouchDB RxStorage, [read this](https://nxpkg.github.io/nxdb/questions-answers.html#why-is-the-pouchdb-rxstorage-deprecated)
...
- ADD [replication-couchdb-new plugin](./docs-src/replication-couchdb-new.md) which can be used to replicate **any** [RxStorage](https://nxpkg.github.io/nxdb/rx-storage.html) with a CouchDB endpoint.
...
- REFACTOR create the `digest` of an attachment inside of the `RxStorage`, not in NxDB. This makes the behavior equal to CouchDB and solves a lot of problems caused by different hashing or base64 encoding of the RxStorage implementations. (Fixes [#4107](https://github.com/nxpkg/nxdb/pull/4107)) Thanks [@Elendiar](https://github.com/Elendiar)
- FIX GraphQL replication: should stop syncing if we receive less docs than pull.batchSize [#4110](https://github.com/nxpkg/nxdb/pull/4110) Thanks [@jwallet](https://github.com/jwallet)

### 13.8.3 (3 November 2022)

- FIX TS Error in Plugin "Replicate-GraphQL" : GraphQL Websocket on "isomorphic-ws" import [#4104](https://github.com/nxpkg/nxdb/pull/4104) Thanks [@jwallet](https://github.com/jwallet)

### 13.8.2 (1 November 2022)

- UPDATE `fake-indexeddb` to version `4.0.0`
- REFACTOR use `webpack` instead of `browserify` in karma tests.
- REMOVE `graphql-client` dependency [#3497](https://github.com/nxpkg/nxdb/pull/3497)
...
- Added [RxCollection.count()](https://nxpkg.github.io/nxdb/rx-query.html#count) queries. [#4096](https://github.com/nxpkg/nxdb/pull/4096)
- REFACTOR index boundary usage for better performance.
- FIX critical bug in query correctness. **IMPORTANT:** If you use the RxStorage [IndexedDB](https://nxpkg.github.io/nxdb/rx-storage-indexeddb.html) or [FoundationDB](https://nxpkg.github.io/nxdb/rx-storage-foundationdb.html), you have to rebuild the indexes by increasing your schema version and running a migration. [#4098](https://github.com/nxpkg/nxdb/pull/4098)
...
- FIX Stop retries when replication gets canceled [#4088](https://github.com/nxpkg/nxdb/pull/4088) Thanks [@Whoops](https://github.com/Whoops)

### 13.6.0 (19 October 2022)

- ADD example [how to use NxDB with Flutter](https://github.com/nxpkg/nxdb/tree/master/examples/flutter)
- FIX many typos from the [TYPOFIX event](https://github.com/nxpkg/nxdb/issues/4024)
- FIX Cannot read properties of null [#4055](https://github.com/nxpkg/nxdb/pull/4055) Thanks [@Albert-Gao](https://github.com/Albert-Gao)
...
- FIX many typos from the [TYPOFIX event](https://github.com/nxpkg/nxdb/issues/4024)
- FIX `lastOfArray()` may return undefined if array is empty [#4011](https://github.com/nxpkg/nxdb/pull/4011) Thanks [@AlexErrant](https://github.com/AlexErrant)
- FIX Remove legacy triple slash directives [#4023](https://github.com/nxpkg/nxdb/pull/4023) Thanks [@jeromepochat](https://github.com/jeromepochat)
- FIX randomly failing replication test
...
- FIX Push batchSize in not respected [#3994](https://github.com/nxpkg/nxdb/issues/3994)
- FIX boolean indexes not working [#3994](https://github.com/nxpkg/nxdb/issues/3994)
...
- UPDATE graphql websocket dependencies [#3980](https://github.com/nxpkg/nxdb/pull/3980) Thanks [@herefishyfish](https://github.com/herefishyfish)
...
- ADD credentials settings to the GraphQL replication plugin [#3976](https://github.com/nxpkg/nxdb/pull/3976) Thanks [@marcoklein](https://github.com/marcoklein)
...
- ADD Support JsonSchema for nested additionalProperties [#3952](https://github.com/nxpkg/nxdb/pull/3952) Thanks [@swnf](https://github.com/swnf)
...
- FIX [#3839](https://github.com/nxpkg/nxdb/pull/3839) executing insert -> remove -> insert -> remove does not work. Thanks [@nisarpeitang](https://github.com/nisarpeitang)
...
- ADD `bulkSize` option to [Memory Synced RxStorage](https://nxpkg.github.io/nxdb/rx-storage-memory-synced.html)
...
- Add the [Memory Synced RxStorage](https://nxpkg.github.io/nxdb/rx-storage-memory-synced.html) to the premium plugins.
...
- Fix `atomicUpsert()` broken when document was replicated before. [#3856](https://github.com/nxpkg/nxdb/pull/3856). Thanks [@AntonOfTheWoods](https://github.com/AntonOfTheWoods)
...
- FIX collections with a dash in the name where not properly removed [#3785](https://github.com/nxpkg/nxdb/pull/3785) Thanks [@mmouterde](https://github.com/mmouterde)
- FIX data still there despite remove and destroy calls [#3788](https://github.com/nxpkg/nxdb/pull/3788) Thanks [@mmouterde](https://github.com/mmouterde)
...
- Added `autoStart` option to the replication plugins [#3775](https://github.com/nxpkg/nxdb/pull/3775) Thanks [@mmouterde](https://github.com/mmouterde)
- Fix [#778](https://github.com/nxpkg/nxdb/pull/3778) Storing string array was broken in the dexie storage. Thanks [@mmouterde](https://github.com/mmouterde)
...
- Removed the `core` plugin. The default export `from 'nxdb'` now exports only the NxDB core without plugins.
...
Bugfixes:
  - [#3666](https://github.com/nxpkg/nxdb/issues/3666) NxDB with lokijs works bad in Safari and FF when using multiple tabs

Other:
  - Replication primitives must throw an error if `_deleted` field is missing. [#3671](https://github.com/nxpkg/nxdb/pull/3671)

### 11.5.1 (30 January 2022)

Bugfixes:
  - `RxStorage.statics.getQueryMatcher()` must not match documents with `_deleted: true`.
  - Fixed multiple problems with `RxCollection.findByIds$()` [#3659](https://github.com/nxpkg/nxdb/pull/3659) Thanks [@Hideman85](https://github.com/Hideman85)
...
Features:
  ...
  - Added Dexie.js based `RxStorage`. [Read the docs](https://nxpkg.github.io/nxdb/rx-storage-dexie.html)

### 11.4.0 (28 January 2022)

Bugfixes:
  - `RxDocument.toJSON()` is leaking meta field `_deleted`. [#3645](https://github.com/nxpkg/nxdb/pull/3645) Thanks [@Bessonov](https://github.com/Bessonov)

Features:
  - Allow truthy values for the GraphQL replication `deletedFlag` field. [#3644](https://github.com/nxpkg/nxdb/pull/3644) Thanks [@nirvdrum](https://github.com/nirvdrum)
...
Bugfixes:
  - GraphQL replication: Unnecessary local document writes fill up the database [#3627](https://github.com/nxpkg/nxdb/pull/3627) Thanks [@hdwatts](https://github.com/hdwatts)
...
Bugfixes:
  ...
  - Support composite indices in schema literal types [#3609](https://github.com/nxpkg/nxdb/pull/3609) Thanks [@nirvdrum](https://github.com/nirvdrum)
...
BREAKING:
  ...
  - `RxStorageInterface`:
    ...
    - `digest` and `length` of attachment data is now created by NxDB, not by the RxStorage. [#3548](https://github.com/nxpkg/nxdb/issues/3548)
  ...
  - Removed the deprecated `recieved` methods, use `received` instead. [See #3392](https://github.com/nxpkg/nxdb/pull/3392)
  - Removed the `no-validate` plugin. To use NxDB without schema validation, just do not add a validation plugin to your custom build.

Bugfixes:
  - Do not throw an error when database is destroyed while a GraphQL replication is running.
  - Compound primary key migration throws "Value of primary key(s) cannot be changed" [#3546](https://github.com/nxpkg/nxdb/pull/3546) Thanks [@nothingkid](https://github.com/nothingkid)
  - Allow `_id` as primaryKey [#3562](https://github.com/nxpkg/nxdb/pull/3562) Thanks [@SuperKirik](https://github.com/SuperKirik)
...
Bugfixes:
  ...
  - Query returns outdated result in second subscription [#3498](https://github.com/nxpkg/nxdb/issues/3498) Thanks [@swnf](https://github.com/swnf)
...
Other:
  - Updated [event-reduce](https://github.com/nxpkg/event-reduce) for more optimizations.
...
Bugfixes:
  - Migration with attachments removes attachment mime types [#3460](https://github.com/nxpkg/nxdb/issues/3460) Thanks [@swnf](https://github.com/swnf)
...
Bugfixes:
  ...
  - `Buffer` is not available in browsers [#3454](https://github.com/nxpkg/nxdb/issues/3454) Thanks [@swnf](https://github.com/swnf)

### 10.2.0 (13 October 2021)

Bugfixes:
  - Observed document data must be deep freezed in dev mode [#3434](https://github.com/nxpkg/nxdb/issues/3434) Thanks [@chrisdrackett](https://github.com/chrisdrackett)
...
Other:
  ...
  - Added svelte example [#3287](https://github.com/nxpkg/nxdb/pull/3287) Thanks [@bkeating](https://github.com/bkeating)
  - Improved error messages

Bugfixes:
  - [#3319](https://github.com/nxpkg/nxdb/issues/3319) Graphql replication checkpoint was not deleted after running `RxDatabase.remove()`
  - Fixed spelling of `recieved -> received` everywhere. The old getters are still useable but `deprecated` [#3392](https://github.com/nxpkg/nxdb/pull/3392). Thanks [chrisdrackett](https://github.com/chrisdrackett)

### 10.0.3 (9 August 2021)

Bugfixes:
  - Calling bulk-methods with an empty array must not throw an error.
  - `RxCollection.remove()` does not delete local documents [#3319](https://github.com/nxpkg/nxdb/issues/3319)
...
Breaking:
  ...
  - Pouchdb plugins are not longer added via `addRxPlugin()` but `addPouchPlugin()`. (NxDB plugins are still added via `addRxPlugin`).
...
Features:
  - Added `dataPath` property to GraphQL replication pull options to allow the document JSON lookup path to configured instead of assuming the document data is always the first child of the response [#2606](https://github.com/nxpkg/nxdb/issues/2606) Thanks [@joshmcarthur](https://github.com/joshmcarthur)
...
Features:
  - Added the [backup-plugin](https://nxpkg.github.io/nxdb/backup.html)
...
Bugfixes:
  - Ensure every background task is done when `RxDatabase.destroy()` resolves. [#2938](https://github.com/nxpkg/nxdb/issues/2938)
...
Bugfixes:
  - Updated `pouchdb-all-dbs` fixes [#2874](https://github.com/nxpkg/nxdb/issues/2874)  Thanks [@openscript](https://github.com/openscript)
...
Other:
  - Added server side rendering to the [angular example](https://github.com/nxpkg/nxdb/tree/master/examples/angular)

### 9.13.0 (10 February 2021)

Features:

  - Added `RxCollection().bulkRemove()` [#2845](https://github.com/nxpkg/nxdb/pull/2845) Thanks [@qinyang912](https://github.com/qinyang912)

Other:

  - Improved typings of `insertLocal()` [#2850](https://github.com/nxpkg/nxdb/pull/2850) Thanks [@openscript](https://github.com/openscript)
  - Improved typings of `bulkInsert()`

### 9.12.1 (24 January 2021)

Bugfixes:
  - [#2785](https://github.com/nxpkg/nxdb/pull/2785) postInsert hook not working when use bulkInsert to insert doc. Thanks [@qinyang912](https://github.com/qinyang912)
  - Setted `sideEffects: true` for main module [#2798](https://github.com/nxpkg/nxdb/issues/2798)
...
Features:
  - Allow `primary` and `ref` at the same time in a schema. [#2747](https://github.com/nxpkg/nxdb/issues/2747)

Bugfixes:
  - [#2705](https://github.com/nxpkg/nxdb/issues/2705) when use bulkInsert to insert doc, the rxDocument property on changeEvent is an object, not a RxDocument instance. Thanks [@qinyang912](https://github.com/qinyang912)
...
Bugfixes:
  - `awaitInitialReplication()` resolves on failed replication [#2745](https://github.com/nxpkg/nxdb/pull/2745). Thanks [@dome4](https://github.com/dome4)
  - `insertLocal()` not emitted the state change across tabs

Other:
  - Added `name` identifier to `RxPlugin`
  - Throw error when `dev-mode` plugin is added multiple times because there is no way that this was done intentional likely the developer has mixed core and default usage of NxDB.
...
Features:
  ...
  - Added [RxDocument.atomicPatch()](https://nxpkg.github.io/nxdb/rx-document.html#atomicpatch)
...
Other:
  ...
  - (docs) added workarounds for 6-connection limit at couchdb replication [#2659](https://github.com/nxpkg/nxdb/pull/2659). Thanks [@MuresanSergiu](https://github.com/MuresanSergiu)

### 9.7.1 (22 October 2020)

Bugfixes:
  - Server-Plugin: Replication did not work until there is at least one document.
  - Fix skipping docs in graphql push replication [#2627](https://github.com/nxpkg/nxdb/pull/2627) Thanks [@DDoerner](https://github.com/DDoerner)

### 9.7.0 (21 October 2020)

Bugfixes:
  - `RxLocalDocument.$` emitted to often on changes [#2471](https://github.com/nxpkg/nxdb/issues/2471)
  - Fix typings of `RxReplicationState.collection`

Features:
  - Allow to skip docs in push/pull modifiers with the graphql-replication. [#2552](https://github.com/nxpkg/nxdb/issues/2552) Thanks [@DDoerner](https://github.com/DDoerner)
  - Allow to type the data of `RxLocalDocument` like `myDatabase.getLocal<{foo: string}>('bar')`

Other:
  - Refactored GraphQL replication to run faster [#2524](https://github.com/nxpkg/nxdb/pull/2524/) Thanks [@corinv](https://github.com/corinv)

### 9.6.0 (7 September 2020)

Features:
  - Add `RxReplicationState.setHeaders()` [#2399](https://github.com/nxpkg/nxdb/pull/2399/) Thanks [@DDoerner](https://github.com/DDoerner)
  - Added `RxCollection.findByIds$()` [see](./docs-src/tutorials/rx-collection.md#findbyids$)

Bugfixes:
  - wrong key handling on compound indexes [#2456](https://github.com/nxpkg/nxdb/pull/2456/) Thanks [@dome4](https://github.com/dome4)
...
Features:
  - Add cache-replacement-policy for the [QueryCache](https://nxpkg.github.io/nxdb/nxdb/query-cache.html)
  - GraphQL replication async modifier function [#2367](https://github.com/nxpkg/nxdb/issues/2367)

Bugfixes:
  - GraphQL replication run increasing requests when offline [#2336](https://github.com/nxpkg/nxdb/issues/2336)
...
Bugfixes:
  - `ref`-fields must be nullable [#2285](https://github.com/nxpkg/nxdb/pull/2285/) Thanks [@kunal15595](https://github.com/DDoerner)
  - RxDatabase names can no longer end with a slash [#2251](https://github.com/nxpkg/nxdb/issues/2251) which breaks the server plugin.
...
Bugfixes:
  - prepareQuery should handle all comparison operators [#2213](https://github.com/nxpkg/nxdb/pull/2213/) Thanks [@kunal15595](https://github.com/kunal15595)
...
Features:
  ...
  - Added helper functions to [GraphQL replication](https://nxpkg.github.io/nxdb/replication-graphql.html) to generate GraphQL Schemas from the `RxJsonSchema`
...
Breaking:
  - Indexes are now specified at the top-level of the schema-definition. [#1655](https://github.com/nxpkg/nxdb/issues/1655)
  ...
  - Replaced plugins `error-messages` and `schema-check` with [dev-mode](https://nxpkg.github.io/nxdb/nxdb/custom-build.html#dev-mode)
  ...
  - The internal `hash()` function does now use a NxDB specific salt
...
Other:
  - The server plugin now exposes the `pouchApp` [#1992](https://github.com/nxpkg/nxdb/pull/1992) Thanks [@Julusian](https://github.com/Julusian)

Features:
  - Added option to replicate revisions with graphql-replication [#2000](https://github.com/nxpkg/nxdb/pull/2000) Thanks [@gautambt](https://github.com/gautambt)
...
Other:
  ...
  - Fixed Typing error on `database.dump()` [#1754](https://github.com/nxpkg/nxdb/issues/1754). Thanks [@PVermeer](https://github.com/PVermeer)

Bugfixes:
  - Updates to documents fail with GraphQL replication. [#1812](https://github.com/nxpkg/nxdb/issues/1812). Thanks [@gautambt](https://github.com/gautambt)
...
Other:
  - Improved performance of `QueryChangeDetection` by using [array-push-at-sort-position](https://github.com/nxpkg/array-push-at-sort-position) instead of re-sorting the whole results of a query
...
Features:
  - NxDB server can now be used with an existing express-app. [#1448](https://github.com/nxpkg/nxdb/issues/1448) Thanks [@dstudzinski](https://github.com/dstudzinski)
...
Bugfixes:
  - Fixed typings of `preCreateRxCollection` [#1533](https://github.com/nxpkg/nxdb/issues/1533) Thanks [@yanshiyason](https://github.com/yanshiyason)

### 8.5.0 (18 September 2019)

Features:
  - Add ability to use `server` app as a part of bigger Express app [#1448](https://github.com/nxpkg/nxdb/issues/1448) Thanks [@dstudzinski](https://github.com/dstudzinski)

Bugfixes:
  - custom server path not working on `server`-plugin [#1447](https://github.com/nxpkg/nxdb/issues/1447) Thanks [@dstudzinski](https://github.com/dstudzinski)
  - Fix CORS headers when the request's credentials mode is 'include' [#1450](https://github.com/nxpkg/nxdb/issues/1450) Thanks [@dstudzinski](https://github.com/dstudzinski)
...
Bugfixes:
  - Fix imports of encryption-plugin to work with rollup [#1413](https://github.com/nxpkg/nxdb/issues/1413) Thanks [@kenshyx](https://github.com/kenshyx)
  - Removed `express-pouchdb` from the dependencies [#884](https://github.com/nxpkg/nxdb/issues/884)

### 8.3.1 (23 August 2019)

Features:
  - Added `RxQuery.doesDocumentDataMatch()` [read the docs](https://nxpkg.github.io/nxdb/rx-query.html#doesdocumentdatamatch)
...
Bugfixes:
  ...
  - json export/import not working when a document has attachments [#1396](https://github.com/nxpkg/nxdb/pull/1396) Thanks [@rixo](https://github.com/rixo)
...
Features:
  - Added a plugin for [GraphQL-replication](https://nxpkg.github.io/nxdb/replication-graphql.html)
...
Features:
  - Add a [z-schema](https://github.com/zaggino/z-schema) validator plugin [#1157](https://github.com/nxpkg/nxdb/pull/1157). Thanks [@phil-lgr](https://github.com/phil-lgr)

Bugfixes:
  - Collection change event was emitted before the actual change happened [#1225](https://github.com/nxpkg/nxdb/pull/1225). Thanks [@milanpro](https://github.com/milanpro)
...
Bugfixes:
  - Vue devtools broke the application [#1126](https://github.com/nxpkg/nxdb/issues/1126)
...
Bugfixes:
  - Fix creating a collection mutates to arguments object [#939](https://github.com/nxpkg/nxdb/pull/939)
  - Fix not having optional encrypted fields in a document throws an error [#917](https://github.com/nxpkg/nxdb/issues/917)
...
Bugfixes:
  - Calling `remove()` on a deleted RxDocument should return a rejected promise [#830](https://github.com/nxpkg/nxdb/issues/830)
  - Passing `auto_compaction` to a collection did not work [via gitter](https://gitter.im/nxpkg/nxdb?at=5c42f3dd0721b912a5a4366b)
  - `util` missing in react-native [#890](https://github.com/nxpkg/nxdb/pull/890)
...
Bugfixes:
  - Reopening a database after using the wrong password did not work [#837](https://github.com/nxpkg/nxdb/issues/837)

### 8.0.2 (7. October 2018)

Features:
  - Allow to use `_id` as primary field [#824](https://github.com/nxpkg/nxdb/pull/824). Thanks [@will118](https://github.com/will118)

Bugfixes:
  - `NxDB.removeDatabase()` did not return a Promise [#822](https://github.com/nxpkg/nxdb/pull/822). Thanks [@will118](https://github.com/will118)

### 8.0.1 (21. September 2018)

Bugfixes:
  - Does not compile in TypeScript with strict flag enabled [#448](https://github.com/nxpkg/nxdb/issues/448)
...
Features:
  ...
  - Added `RxReplicationState.denied$` [#763](https://github.com/nxpkg/nxdb/issues/763)
  - Added option for CORS to server-plugin
  - `this`-scope of collection-hooks are bound to the collection itself [#788](https://github.com/nxpkg/nxdb/issues/788)
  - All methods of `RxDocument` are bound to the instance [#791](https://github.com/nxpkg/nxdb/issues/791)
  - Added `RxReplicationState.alive$`, [see](./docs-src/replication.md#alive). Thanks [@rafamel](https://github.com/rafamel)

Bugfixes:
  - checkAdapter doesn't cleanup test databases [#714](https://github.com/nxpkg/nxdb/issues/714)
  - inMemory collections don't implement static methods [#744](https://github.com/nxpkg/nxdb/issues/744)
  - inMemory collections do not sync up removals [#754](https://github.com/nxpkg/nxdb/issues/754)
...
Other:
  - cross-instance communication is now done with https://github.com/nxpkg/broadcast-channel (way better performance)
...
Bugfixes:
  - newRxError is not a constructor [#719](https://github.com/nxpkg/nxdb/issues/719) thanks [@errorx666](https://github.com/errorx666)
  - Collection name validation is too strict [#720](https://github.com/nxpkg/nxdb/issues/720) thanks [@errorx666](https://github.com/errorx666)
  - Field names can't be one character long [#717](https://github.com/nxpkg/nxdb/issues/717) thanks [@errorx666](https://github.com/errorx666)
  - Invalid value persists in document after failed update [#734](https://github.com/nxpkg/nxdb/issues/734) thanks [@rybaczewa](https://github.com/rybaczewa)

Other
  - Moved `@types/core-js` to dev-dependencies [#712](https://github.com/nxpkg/nxdb/issues/712)
  - Added more example the the RxQuery-Docs [#740](https://github.com/nxpkg/nxdb/pull/740) thanks [@Celludriel](https://github.com/Celludriel)

### 7.7.0 (July 6, 2018)

Bugfixes:
  - Indexes do not work in objects named "properties" [#697](https://github.com/nxpkg/nxdb/issues/697)
  - Wrong pouch-location when folderpath used for collection [#677](https://github.com/nxpkg/nxdb/issues/677)
  - Mutating a result-array from `RxQuery.exec()` or `RxQuery.$` does not affect future calls [#698#issuecomment-402604237](https://github.com/nxpkg/nxdb/issues/698#issuecomment-402604237)
...
Bugfixes:
  - Unhandled promise rejection with DOMException [#644](https://github.com/nxpkg/nxdb/issues/644)
  - Prevent bug with replication of internal pouchdb's [#641](https://github.com/nxpkg/nxdb/pull/641)
  - LocalDocument observe on field not working [#661](https://github.com/nxpkg/nxdb/issues/661)
  - Skip defining getter and setter when property not defined in schema [#646](https://github.com/nxpkg/nxdb/pull/646)
  - (typings) Fix `type: 'object'` not correctly recognized (via gitter at 2018 Mai 22 19:20)

### 7.6.0 (May 12, 2018)

Bugfixes:
  - Query cache is not being invalidated by replication [#630](https://github.com/nxpkg/nxdb/issues/630)
...
Bugfixes:
  - Indexes are no longer required thx [@gvuyk](https://github.com/gvuyk) [#620](https://github.com/nxpkg/nxdb/issues/620)
...
Features:
  - Added `RxCollection.insert$`, `RxCollection.update$`, `RxCollection.remove$` [read the docs](https://nxpkg.github.io/nxdb/rx-collection.html#observe-)
...
Bugfixes:
  - Wrong index used when no sort specified [#609](https://github.com/nxpkg/nxdb/issues/609)
...
Bugfixes:
  - Sort by sub object is not working [#585](https://github.com/nxpkg/nxdb/issues/585)
  - Encrypted attachments not working inside of electron-renderer [#587](https://github.com/nxpkg/nxdb/issues/587)
  - Schema fails with sub-sub-index [#590](https://github.com/nxpkg/nxdb/issues/590)
  - Default value not applied when the stored value is `undefined` [#596](https://github.com/nxpkg/nxdb/issues/596)

### 7.4.2 (March 22, 2018)

Bugfixes:
  - Wrong typings with custom build [#576](https://github.com/nxpkg/nxdb/issues/576)

Features:
  - Add option to add pouchSettings to all pouchdb-instances [#567](https://github.com/nxpkg/nxdb/pull/567) Thx [@EugeniaM](https://github.com/EugeniaM)

### 7.4.1 (March 11, 2018)

Bugfixes:
  - Remove preinstall-script [#558](https://github.com/nxpkg/nxdb/issues/558) thx [@adam-lebon](https://github.com/adam-lebon)

### 7.4.0 (March 9, 2018)

Features:
  - Added `RxDatabase.server()` to quickly spawn couchdb-compatibe endpoint out of NxDB. Read [this](https://nxpkg.github.io/nxdb/nxdb/custom-build.html#server)
  - Use `CustomIdleQueue` for atomic updates to enable [#494](https://github.com/nxpkg/nxdb/issues/494)

Bugfixes:
  - Default ignored when `0` [#528](https://github.com/nxpkg/nxdb/pull/528) thx [@gvuyk](https://github.com/gvuyk)
...
Other:
  - Improved [react-native-example](https://github.com/nxpkg/nxdb/tree/master/examples/react-native) thx [@Darkbladecr](https://github.com/Darkbladecr)

### 7.3.1 (January 3, 2018)

Bugfixes:
  - Allow `number`-fields as index [#438](https://github.com/nxpkg/nxdb/pull/438)
  - Ensure typescript `strict: true` works [#448](https://github.com/nxpkg/nxdb/issues/448)

### 7.3.0 (December 18, 2017)

Features:
  - Added [ajv-validate](https://nxpkg.github.io/nxdb/nxdb/custom-build.html#ajv-validate)-plugin. Thx [@rybaczewa](https://github.com/rybaczewa)
...
Other:
  ...
  - do not hide fields with `value: undefined` in error-message [#403](https://github.com/nxpkg/nxdb/issues/403)

## 7.2.0 (December 7, 2017)

Warning:
  - Removed automatic import of `pouchdb-adapter-memory` for in-memory-collections. Read [this](https://nxpkg.github.io/nxdb/nxdb/in-memory.html)

Features:
  - Added [options-parameter](https://nxpkg.github.io/nxdb/nxdb/plugins.html#options)
  - Added `postCreateRxDocument` [plugin-hook](https://github.com/nxpkg/nxdb/blob/master/src/hooks.js)
  - Added [no-validate-plugin](https://nxpkg.github.io/nxdb/nxdb/custom-build.html#no-validate)
...
Other:
  ...
  - Split out error-messages into separate [own plugin](https://nxpkg.github.io/nxdb/nxdb/custom-build.html#error-messages)
...
Other:
  - Reduced build-size by using [rxjs-lettable-operators](https://github.com/ReactiveX/rxjs/blob/master/doc/lettable-operators.md). Read [this](https://github.com/nxpkg/nxdb/blob/master/docs-src/install.md#rxjs) if you have problems.
  - Improved typings [#368](https://github.com/nxpkg/nxdb/pull/368) thx [@FlorianKoerner](https://github.com/FlorianKoerner)

## 7.0.1 (November 14, 2017)

Bugfixes:
  - Include `pouchdb-adapter-memory` as dependency [#365](https://github.com/nxpkg/nxdb/issues/365)

## 7.0.0 (November 14, 2017)

Breaking:
  - Renamed `ingoreDuplicate` to `ingoreDuplicate` [#314](https://github.com/nxpkg/nxdb/issues/314)
  - Improved typings [#329](https://github.com/nxpkg/nxdb/pull/329) by [@ihadeed](https://github.com/ihadeed)

Features:
  - Added [attachments](https://nxpkg.github.io/nxdb/nxdb/rx-attachment.html)
  - Added [final fields](https://nxpkg.github.io/nxdb/nxdb/rx-schema.html#final)
  - Added [inMemory](https://nxpkg.github.io/nxdb/nxdb/in-memory.html)-collections
  - Added [local documents](https://nxpkg.github.io/nxdb/nxdb/rx-local-document.html)

Bugfixes:
  - Added error-message when you json-import on a non-existing collection [#319](https://github.com/nxpkg/nxdb/issues/319)
  - Allow windows-foldernames (with backslash) as collection-name [343](https://github.com/nxpkg/nxdb/issues/343)
...
- Fix `core is not defined` [#296](https://github.com/nxpkg/nxdb/issues/296)
...
Breaking:
  ...
  - `NxDB.create()` throws if you create the same database twice. (You can use [ignoreDuplicate](https://nxpkg.github.io/nxdb/nxdb/rx-database.html#ignoreduplicate))

Features:
  - Added [RxDatabase.requestIdlePromise()](https://nxpkg.github.io/nxdb/nxdb/rx-database.html#requestidlepromise)
  - Added [NxDB.checkAdapter()](https://nxpkg.github.io/nxdb/nxdb/rx-database.html#checkadapter)
  - Added [ignoreDuplicate](https://nxpkg.github.io/nxdb/nxdb/rx-database.html#ignoreduplicate)-parameter to `NxDB.create()`

Custom-Build:
  - Custom-build is now out of beta
  - If you use a custom-build, you have to change the import-paths. See [custom-build](https://nxpkg.github.io/nxdb/nxdb/custom-build.html)
  - Replication is now its own module [see](https://nxpkg.github.io/nxdb/nxdb/custom-build.html#replication)
  - Json import/exportis now its own module [see](https://nxpkg.github.io/nxdb/nxdb/custom-build.html#json-dump)

Bugfixes:
  - Allow null-selector [#267](https://github.com/nxpkg/nxdb/issues/267)
  - `RxQuery.exec()` throws when out of change-event-buffer-bounds [#278](https://github.com/nxpkg/nxdb/issues/278)
  - Fix deprecated warning that sometimes occurs with indexeddb-adapter `db.type()`
  - Add fallback to leader-election when [unload](https://github.com/nxpkg/unload) not works (mostly when you use NxDB inside of an iFrame)
...
Features:
  - Added [custom builds](https://nxpkg.github.io/nxdb/nxdb/custom-build.html)
  - Added [plugin-support](https://nxpkg.github.io/nxdb/nxdb/plugins.html)
  - Added default exports. Use `import NxDB from 'nxdb'` instead of `import * as NxDB from 'nxdb'`

Bugfixes:
  - `RxQuery.or()` did not work with KeyCompression [#252](https://github.com/nxpkg/nxdb/issues/252)
...
Features:
  - Added [RxCollection.atomicUpsert](https://nxpkg.github.io/nxdb/nxdb/rx-collection.html#atomicupsert)
  - Added [default values](https://nxpkg.github.io/nxdb/nxdb/rx-schema.html#default)
...
Other:
  - Split out test-util into its own npm-module [async-test-util](https://github.com/nxpkg/async-test-util)
  - Upgrade to pouchdb version [6.3.4](https://github.com/pouchdb/pouchdb/releases/tag/6.3.4)

Bugfixes:
  - Settings values to `null` did not work on temporaryDocuments [#215](https://github.com/nxpkg/nxdb/issues/215)
  - `RxDocument.atomicUpdate()` did not run when reusing after a while
  - `RxQuery.toString()` was sometimes not predictable

**WARNING**: If you use NxDB with angular2||zone.js, you might have the error [_global is not defined](https://github.com/angular/zone.js/issues/835). Wait for the next zone.js release before updating NxDB.
...
Bugfixes:
  - AutoMigrated caused infinity-loop [#212](https://github.com/nxpkg/nxdb/issues/212)
...
Features:
  - Added `RxDocument.atomicUpdate()` [docs](https://nxpkg.github.io/nxdb/nxdb/rx-document.html#atomicUpdate)
  - Added `RxCollection.remove()` [docs](https://nxpkg.github.io/nxdb/nxdb/rx-collection.html#clear)
  - Added `RxDatabase.remove()` [docs](https://nxpkg.github.io/nxdb/nxdb/rx-database.html#remove)
  - Added options for `RxCollection.sync()`: direction and pouchdb-replication-settings [docs](https://nxpkg.github.io/nxdb/nxdb/rx-collection.html#sync)
  - Added query-param for `RxCollection.sync()` to allow selector-based replication [docs](https://nxpkg.github.io/nxdb/nxdb/rx-collection.html#sync)
  - Added TemporaryDocuments `RxCollection.newDocument()` [docs](https://nxpkg.github.io/nxdb/nxdb/rx-collection.html#newDocument)

Breaking:
  - `postCreate`-hooks can no longer be async
  - `RxCollection.sync()` completely changed [docs](https://nxpkg.github.io/nxdb/nxdb/replication.html)
...
Features:
  - Added `postCreate`-[hook](https://nxpkg.github.io/nxdb/nxdb/middleware.html#postCreate) [#165](https://github.com/nxpkg/nxdb/issues/165)
...
Bugfixes:
  - QueryCache returns old RxQuery when `.regex()` is used [#190](https://github.com/nxpkg/nxdb/issues/190)
  - `RxDocument.resync()` was broken [174](https://github.com/nxpkg/nxdb/issues/174)

Other:
  - Throw error if `RxQuery.sort()` runs on field which is not in the schema [#146](https://github.com/nxpkg/nxdb/issues/146)
  - extract `watchForChanges` to allow custom sync-operations [#197](https://github.com/nxpkg/nxdb/pull/197)
...
Bugfixes:
  - `jsnext:main` and `module` now point to es6 instead of es7-stage-0 [commit](https://github.com/nxpkg/nxdb/commit/d3a14cc417b04e32e2c534908dc62b0bcd654a5f) [issue](https://github.com/nxpkg/nxdb/issues/172)
  - Sort on primary fails without non-id primary [commit](https://github.com/nxpkg/nxdb/commit/59143a61530069f6e90ae203019d494d507330e9)
  - QueryChangeDetection breaks on no-resort-optimisation [commit](https://github.com/nxpkg/nxdb/commit/c7f9b3e601d0bfbbde3ee410f00b017b4490dded)

## 4.0.0 (May 5, 2017) BREAKING

Breaking:
  - RxQuery's are now [immutable](https://nxpkg.github.io/nxdb/nxdb/rx-query.html#notice-rxquerys-are-immutable)
  - RxQuery.$ does not emit `null` when running
  - RxQuery will sort by primary (ASC) as default

Features:
  - Added [QueryChangeDetection](https://nxpkg.github.io/nxdb/nxdb/query-change-detection.html) (in **beta**, disabled by default)
...
Features:
  - [Population](https://nxpkg.github.io/nxdb/nxdb/population.html) can now be done on arrays
...
Bugfixes:
  - Vuejs runs populate-getter on changedetection [#75](https://github.com/nxpkg/nxdb/issues/75)
  - `isDeepEqual` does not work correctly for Arrays [#76](https://github.com/nxpkg/nxdb/issues/76)
  - wrong `storageEngine` in the typings

## 3.0.3 (March 6, 2017)

Features:
  - Added RxDocument.[deleted](https://nxpkg.github.io/nxdb/nxdb/rx-document.html#get-deleted)
  - Added RxDocument.[synced](https://nxpkg.github.io/nxdb/nxdb/rx-document.html#get-synced)
...
Bugfixes:
  - No error on sync when remote document is deleted [680f75bfcbda3f71b6ba0a95ceecdc6b6f30ba58](https://github.com/nxpkg/nxdb/commit/680f75bfcbda3f71b6ba0a95ceecdc6b6f30ba58)

## 3.0.2 (March 2, 2017)

Bugfixes:
  - compound-index not being created [#68](https://github.com/nxpkg/nxdb/issues/68)

## 3.0.1 (March 2, 2017)

Bugfixes:
  - new document does not get new state on remove-reinsert [#66](https://github.com/nxpkg/nxdb/issues/66)

## 3.0.0 (February 27, 2017) BREAKING

Features:
  - added [DataMigration](https://nxpkg.github.io/nxdb/nxdb/data-migration.html)
  - added [ORM/DRM](https://nxpkg.github.io/nxdb/nxdb/orm.html)-capabilities
  - added [RxQuery.remove()](https://nxpkg.github.io/nxdb/nxdb/rx-query.html)
  - added [Population](https://nxpkg.github.io/nxdb/nxdb/population.html)
  - added [RxDocument.deleted$](https://nxpkg.github.io/nxdb/nxdb/rx-document.html#deleted)
  - added [RxDocument.synced$](https://nxpkg.github.io/nxdb/nxdb/rx-document.html#synced)
  - added [RxDocument.resnyc()](https://nxpkg.github.io/nxdb/nxdb/rx-document.html#resync)
  - added [RxCollection.upsert()](https://nxpkg.github.io/nxdb/nxdb/rx-document.html#synced)
...
Breaking:
  ...
  - NxDB.create has new api with destructuring [see](https://nxpkg.github.io/nxdb/nxdb/rx-database.html)
  - RxDatabase.collection() has new api with destructuring [see](https://nxpkg.github.io/nxdb/nxdb/rx-database.html)
...
Bugfixes:
  - top-level array of document not working [#50](https://github.com/nxpkg/nxdb/issues/50)
  - event on document.remove() not fired at query-obserable [#52](https://github.com/nxpkg/nxdb/issues/52)
...
Bugfixes:
  ...
  - ADD babel-polyfill to dependencies [#40](https://github.com/nxpkg/nxdb/issues/40)
...
Breaking:
  ...
  - RxQuery.$ only emits when the result actually changes [#31](https://github.com/nxpkg/nxdb/issues/31)
...
Features:
  - add [Proxy-wrapping arround RxDocument](https://nxpkg.github.io/nxdb/nxdb/rx-document.html)

## 1.6.7 (January 11, 2017)

Features:
  - add [middleware-hooks](https://nxpkg.github.io/nxdb/nxdb/middleware.html)
...
Features:
  ...
  - added [leader-election](https://nxpkg.github.io/nxdb/nxdb/leader-election.html)
