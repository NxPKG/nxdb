...
import { graphQLSchemaFromRxSchema } from 'nxdb/plugins/replication-graphql';

import { lastOfArray } from 'nxdb';
...
export async function run() {
    ...
    /**
     * In this example we generate the GraphQL schema from the NxDB schema.
