...
/**
 * This script starts the public signaling server for NxDB at wss://signaling.nxdb.nxpkg.github.io
 ...
 * > certbot certonly --agree-tos --preferred-challenges http -d signaling.nxdb.nxpkg.github.io --webroot -w /nxdb/scripts/acme-challenge
 *
 *
 */

const sslKeyPath = '/etc/letsencrypt/live/signaling.nxdb.nxpkg.github.io/privkey.pem';
const sslCertPath = '/etc/letsencrypt/live/signaling.nxdb.nxpkg.github.io/fullchain.pem';
