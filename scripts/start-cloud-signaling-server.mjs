...
/**
 * This script starts the public signaling server for NxDB at wss://signaling.nxdb.khulnasoft.com
 ...
 * > certbot certonly --agree-tos --preferred-challenges http -d signaling.nxdb.khulnasoft.com --webroot -w /nxdb/scripts/acme-challenge
 *
 *
 */

const sslKeyPath = '/etc/letsencrypt/live/signaling.nxdb.khulnasoft.com/privkey.pem';
const sslCertPath = '/etc/letsencrypt/live/signaling.nxdb.khulnasoft.com/fullchain.pem';
