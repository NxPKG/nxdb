            ...
            errorEntries.map(([errorCode, errorMessage]) => {
                ...
                >
                    ...
                    <ul style={styles.innerUl}>
                        <li>
                            <a href={'https://github.com/nxpkg/nxdb/search?q=' + errorCode + '&type=code'} target="_blank">Search In Code</a>
                        </li>
                        <li>
                            <a href={'https://github.com/nxpkg/nxdb/search?q=' + errorCode + '&type=issues'} target="_blank">Search In Issues</a>
                        </li>
                        <li>
