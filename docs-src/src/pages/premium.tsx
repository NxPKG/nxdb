    ...
    return (
        <>
            ...
            <Layout
                ...
                description="NxDB plugins for professionals. FAQ, pricing and license"
            >
                <main>
                    <div className="block first" id="price-calculator-block">
                        <div className="content centered">
                            <h2>
                                NxDB Premium <b className="underline">Price Calculator</b>
                            </h2>
                            <p style={{ width: '80%' }}>
                                NxDB's Premium plugins offer advanced features and optimizations that enhance application <b>performance</b>{' '}
                                and are backed by dedicated support and regular updates. Using the premium plugins is recommended for users
                                that use NxDB in a professional context. If you use NxDB in your side project,
                                            ...
                                            {/* <div className="package bg-gradient-left-top">
                                                <div className="package-inner">
                                                    ...
                                                    <p>
                                                        ...
                                                        longer get any updates from newer NxDB versions.
                                                        <br />
                                                    </p>
                                                </div>
                                            </div> */}
                    ...
                    <div className="block dark" id="faq">
                        <div className="content centered premium-faq">
                            ...
                            <details>
                                ...
                                NxDB Core is open source and many use cases can be implemented with the Open Core part of
                                NxDB. There are many{' '}
                            ...
                            <details>
                                ...
                                The development of NxDB started in 2016 and after all these years it
                                became clear that big implementation and improvement steps will not be
                                done by the NxDB community. While the community submits valuable pull
                                ...
                                only be done by the NxDB maintainer.
                                <br />
                                Selling NxDB Premium ensures that there will be always an incentive for
                                ...
                                that NxDB is a <b>future proof</b> tech stack to build on which lets
                                NxDB stand out compared to similar technologies.
                            </details>
                            <details>
                                <summary>Why is there no free trial period?</summary>
                                <ul>
                                    <li>
                                        NxDB is written in JavaScript and the code of the Premium Plugins
                                    ...
                                    <li>
                                        ...
                                        writing NxDB code. So handling trial period users is just not
                            ...
                            <details>
                                ...
                                there can be always one person that develops NxDB <b>full time</b>.
                                Compared to other JavaScript frameworks and developer tools, NxDB
                                ...
                                to do that and rely on the traditional client-server stack. So NxDB
                            ...
                            <details>
                                ...
                                contribution to NxDB or one of NxDB's dependencies or to the Open Source
                                Community overall. Also for private personal projects there is the
                                option to solve one of the
                                <a
                                    href="https://github.com/nxpkg/nxdb/blob/master/orga/premium-tasks.md"
                                    target="_blank"
                                >
                                    Premium Tasks
                                </a>
                            ...
                            <details>
                                ...
                                you build your application with NxDB and deploy it to production, it
                                will not make requests from your users to any NxDB server.
                            </details>
                        </div>
                    </div>
                    ...
                    <div className="block">
                        <div className="content centered">
                            <h2>
                                NxDB Premium Plugins <b className="underline">Overview</b>
                            </h2>
                            {/* <p style={{ width: '80%' }}>
                                NxDB's premium plugins offer advanced features and optimizations that enhance application <b>performance</b>{' '}
                                and are backed by dedicated support and regular updates. Using the premium plugins is recommended for users
                                that use NxDB in a professional context.
                            </p> */}
                                ...
                                <a href="/reactivity.html" target="_blank">
                                    <div className="premium-block hover-shadow-middle bg-gradient-left-top">
                                        <div className="premium-block-inner">
                                            ...
                                            <p>
                                                An extension for Vue.js to get vue shallow-ref objects to observe NxDB state instead of rxjs observables.
                                            </p>
                                        </div>
                                    </div>
                                </a>
                                <a href="/reactivity.html" target="_blank">
                                    <div className="premium-block hover-shadow-middle bg-gradient-right-top">
                                        <div className="premium-block-inner">
                                            ...
                                            <p>
                                                An extension for react/preact to get preact signals to observe NxDB state instead of rxjs observables.
                                            </p>
                                        </div>
                                    </div>
                                </a>
