 ...
 * Therefore just use a nxdb.khulnasoft.com link that redirects to pipedrive.
...
export default function LicensePreview() {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            const newUrl = 'https://nxdb.pipedrive.com/documents/p/' + myParamFileCode;
            if (goalUrl !== newUrl) {
                setGoalUrl(newUrl);
