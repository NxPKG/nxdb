      ...
      */}
          ...
          <div className="block frameworks">
            <div className="content">
              ...
              <a
                href="https://nxpkg.github.io/capacitor-database.html#nxdb"
                target="_blank"
              >
                <div
                  className="neumorphism-circle-m circle centered enlarge-on-mouse"
              ...
              <a
                href="https://nxpkg.github.io/rx-storage-denokv.html"
                target="_blank"
              >
                <div
                    ...
                    <div className="buy-option-inner">
                      ...
                      {/* <div className="buy-option-features">
                        <ul>
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-sqlite.html"
                              target="_blank"
                            >
                              SQLite RxStorage
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-opfs.html"
                              target="_blank"
                            >
                              OPFS RxStorage
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-indexeddb.html"
                              target="_blank"
                            >
                              IndexedDB RxStorage
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-memory-synced.html"
                              target="_blank"
                            >
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-sharding.html"
                              target="_blank"
                            >
                              Sharding Plugin
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/query-optimizer.html"
                              target="_blank"
                            >
                              Query Optimizer
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/migration-storage.html"
                              target="_blank"
                            >
                              Storage Migrator
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-localstorage-meta-optimizer.html"
                              target="_blank"
                            >
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-shared-worker.html"
                              target="_blank"
                            >
                              Shared Worker
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxpkg.github.io/rx-storage-worker.html"
                              target="_blank"
                            >
                              Worker
                            </a>
