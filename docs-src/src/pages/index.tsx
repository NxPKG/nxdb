...
async function startLandingpageAnimation() {
   ...
   * @link https://github.com/nxpkg/nxdb/pull/3800
  ...
  return (
    <>
      ...
      <Layout
        ...
        description="NxDB is a fast, local-first NoSQL-database for JavaScript Applications like Websites, hybrid Apps, Electron-Apps, Progressive Web Apps and Node.js">
        <main>
                ...
                <div className="half left">
                  ...
                  {/* <ul className="checked">
                    ...
                    <li>
                      ...
                      With the flexible NxDB storage layer you can run the
                    ...
                    <li>
                      ...
                      Years of performance optimization made NxDB one of the <u>fastest</u> ways
          ...
          <div className="block second dark">
            <div className="content">
              ...
              <p>
                From the results of a query, to a single field of a document, with NxDB
                ...
                NxDB supports <b>RxJS</b> and <a href="/reactivity.html" target="_blank">any reactiveness libraries</a> like signals, hooks or vue.js-refs.
              </p>
              <div className="inner">
                {/*
      ...
      */}
          ...
          <a
            href="https://twitter.com/intent/user?screen_name=nxdbjs"
            onClick={() => trigger('twitter_trophy_click', 0.20)}
            target="_blank"
          >
            <div className="trophy twitter">
              <img loading="lazy" src="/files/icons/twitter-blue.svg" alt="NxDB Twitter" />
              <div style={{ flex: 1 }}>
            ...
            <div className="content">
              <div className="half left">
                ...
                <p>
                  ...
                  NxDB has a simple yet high performance <a href="/replication.html" target="_blank">replication protocol</a> that enables you to
              ...
              <div className="half left">
                <div className="replication-icons">
                  ...
                  <a href="https://github.com/nxpkg/nxdb/tree/master/examples/supabase" target="_blank">
          ...
          >
            <div className="trophy discord">
              <img loading="lazy" src="/files/icons/discord.svg" alt="NxDB Discord chat" />
              <div style={{ flex: 1 }}>
              ...
              <div className="full-width">
                <div className="half left">
                  <p>
                    ...
                    replicating it in the background. NxDB can even be used solely on
          ...
          <div className="block frameworks">
            <div className="content">
              <a
                href="https://github.com/nxpkg/nxdb/tree/master/examples/angular"
                target="_blank"
              >
                <div
              ...
              <a
                href="https://nxdb.khulnasoft.com/capacitor-database.html#nxdb"
                target="_blank"
              >
                <div
                  className="neumorphism-circle-m circle centered enlarge-on-mouse"
              ...
              <a
                href="https://nxdb.khulnasoft.com/rx-storage-denokv.html"
                target="_blank"
              >
                <div
              ...
              <a
                href="https://github.com/nxpkg/nxdb/tree/master/examples/node"
                target="_blank"
              >
                <div
                  className="neumorphism-circle-m circle centered enlarge-on-mouse"
              ...
              <a
                href="https://github.com/nxpkg/nxdb/tree/master/examples/react"
                target="_blank"
              >
                <div
                  className="neumorphism-circle-m circle centered enlarge-on-mouse"
              ...
              <a
                href="https://github.com/nxpkg/nxdb/tree/master/examples/svelte"
                target="_blank"
              >
                <div
                  className="neumorphism-circle-s circle centered enlarge-on-mouse"
              ...
              <p>
                NxDB is based on storage plugins that enables you to swap out the
                underlying storage engine depending on your runtime. We have storages for <b>Browsers</b>, <a
                  href="https://github.com/nxpkg/nxdb/tree/master/examples/react-native"
                  target="_blank"
                >ReactNative</a>,{' '}<a
                  href="https://github.com/nxpkg/nxdb/tree/master/examples/node"
                  target="_blank"
                >Node.js</a>,{' '}<a
                  href="https://github.com/nxpkg/nxdb/tree/master/examples/electron"
                  target="_blank"
              ...
              <div className="below-text">
                ...
                <a
                  href="https://github.com/nxpkg/nxdb/tree/master/examples/vue"
                  target="_blank"
                >
                  <div
                    className="neumorphism-circle-s circle centered enlarge-on-mouse"
                ...
                <a
                  href="https://github.com/nxpkg/nxdb/tree/master/examples/ionic2"
                  target="_blank"
                >
                  <div
                    className="neumorphism-circle-s circle centered enlarge-on-mouse"
                ...
                <a
                  href="https://github.com/herefishyfish/nxdb-nativescript"
                  target="_blank"
                >
                  <div
                    className="neumorphism-circle-m circle centered enlarge-on-mouse"
                ...
                <a
                  href="https://github.com/nxpkg/nxdb/tree/master/examples/flutter"
                  target="_blank"
                >
                  <div
                    className="neumorphism-circle-s circle centered enlarge-on-mouse"
          ...
          <div className="block features dark">
            <div className="content">
              ...
              <p>
                Since its beginning in 2018, NxDB has gained a huge set of features and plugins which makes it a flexible full solution regardless of which type of application you are building.
              ...
              <div className="inner">
                ...
                <div className="box dark">
                  ...
                  <a
                    ...
                    href="https://www.npmjs.com/package/nxdb"
                    rel="noopener"
                    target="_blank"
                  >
                    238572
                ...
                <div className="box dark">
                  ...
                  <a
                    className="value"
                    href="https://github.com/nxpkg/nxdb/graphs/contributors"
                    rel="noopener"
                    target="_blank"
                  >
                    211
                ...
                <div className="box dark">
                  ...
                  <a
                    className="value"
                    href="https://github.com/nxpkg/nxdb/commits/master"
                    rel="noopener"
                    target="_blank"
                  >
                    10409
                ...
                <div className="box dark">
                  ...
                  <div className="label">NxDB made Projects</div>
                  <a
                    className="value"
                    href="https://github.com/nxpkg/nxdb/network/dependents?package_id=UGFja2FnZS0xODM0NzAyMw%3D%3D"
                    rel="noopener"
                    target="_blank"
                  >
                    1402
          ...
          <div className="block reviews">
            <div className="content centered">
              <div className="inner">
                ...
                <p>
                  NxDB is a proven technology used by thousands of developers worldwide. <br />
                  With its flexibility, NxDB is used in a diverse range of apps and services.
                </p>
                <br /><br />
              </div>
            </div>
                ...
                <div className="buy-options">
                  <div className="buy-option bg-gradient-left-top">
                    <div className="buy-option-inner">
                      ...
                      <div className="buy-option-features">
                        <p>
                          The NxDB Open Core provides a robust and reliable database engine
                  ...
                  <div className="buy-option bg-gradient-right-top">
                    <div className="buy-option-inner">
                      ...
                      <div className="buy-option-features">
                        <p>
                          Our Premium Plugins are essential for professionals using NxDB.
                          They boost the basic features of NxDB with significant performance improvements and reduced bundle size.
                        </p>
                        <ul>
                          <li>
                      ...
                      {/* <div className="buy-option-features">
                        <ul>
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-sqlite.html"
                              target="_blank"
                            >
                              SQLite RxStorage
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-opfs.html"
                              target="_blank"
                            >
                              OPFS RxStorage
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-indexeddb.html"
                              target="_blank"
                            >
                              IndexedDB RxStorage
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-memory-synced.html"
                              target="_blank"
                            >
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-sharding.html"
                              target="_blank"
                            >
                              Sharding Plugin
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/query-optimizer.html"
                              target="_blank"
                            >
                              Query Optimizer
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/migration-storage.html"
                              target="_blank"
                            >
                              Storage Migrator
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-localstorage-meta-optimizer.html"
                              target="_blank"
                            >
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-shared-worker.html"
                              target="_blank"
                            >
                              Shared Worker
                            </a>
                          ...
                          <li>
                            <a
                              href="https://nxdb.khulnasoft.com/rx-storage-worker.html"
                              target="_blank"
                            >
                              Worker
                            </a>
          ...
          <div className="block last">
            <div className="content">
              <h2>
                Start using <b className="underline">NxDB</b> today
              </h2>
