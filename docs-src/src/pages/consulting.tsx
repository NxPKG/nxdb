                        ...
                        <div className="content">
                            <div className="inner centered">
                                ...
                                <h3>
                                    ...
                                    their experiences working with NxDB. Get to
                ...
                <div className="navbar__inner">
                    <div className="navbar-home-links">
                        <a className="nav-logo-consulting" href="/">
                            <img src="/files/logo/logo.svg" alt="NxDB" />
                            NxDB
                        </a>
    ...
    const packageItems = [
        {
            ...
            price: '180€',
            description:
                'Schedule a quick consultancy session where the NxDB core maintainer answers all your questions and gives suggestions on how you should use NxDB or related technologies.',
            cta: 'Schedule a call',
...
function BenefitsBlock() {
    ...
    const description =
        'Any type of support is possible: from full development to only helping support or code review. We can do Custom NxDB features.';
    ...
    const benefitsPanels = [
        ...
        },
        {
            ...
            text: `We can developer tailored features for NxDB
...
function StepsBlock({ onOpenDialog }) {
    ...
    const stepsItems = [
        ...
        },
        {
            ...
            text: 'We specify the collaboration between you and NxDB and define a roadmap.',
        },
        {
            label: 'Development',
    ...
    const items = [
        {
            ...
            children: 'Everything from react to Vue to Angular to Svelte. We know all frameworks and how to use them efficiently with NxDB.',
        },
        {
            key: '2',
            label: 'Which platforms are supported?',
            children: 'We can build web-apps for browsers, hybrid apps and progressive web apps. Even server-side NxDB projects can be realized.',
        },
        {
            key: '3',
...
function NextBlock({ onOpenDialog }) {
    ...
    const description = `Transform your project with NxDB. Schedule your
