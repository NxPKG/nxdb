...
export default function Meeting() {
    ...
    return (
        <Layout
            ...
            description="NxDB Meeting Scheduler"
        >
            <main>
                <div className='redirectBox' style={{ textAlign: 'center' }}>
                    ...
                    <h1>NxDB Meeting Scheduler</h1>
                    <p>
                        <b>You will be redirected in a few seconds.</b>
                    </p>
                    <p>
                        <a href="https://nxdb.pipedrive.com/scheduler/Z6A0M1sr/nxdb-1h-paid-consulting-session">Click here</a>
                    </p>
                    <meta httpEquiv="Refresh" content="0; url=https://nxdb.pipedrive.com/scheduler/Z6A0M1sr/nxdb-1h-paid-consulting-session" />
                </div>
            </main>
        </Layout >
    );
