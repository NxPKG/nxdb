...
export default function FooterWrapper() {
  ...
  const footerConfig = {
    navLinks: [
      ...
      {
        label: 'LinkedIn',
        href: 'https://www.linkedin.com/company/nxdb',
        target: '_blank',
      }
    ],
    communityLinks: [
      ...
      },
      {
        ...
        href: 'https://stackoverflow.com/questions/tagged/nxdb',
        target: '_blank',
  ...
  const rightsText = `© ${new Date().getFullYear()} NxDB. All rights reserved.`;
  return (
    <>
      {/* <Footer {...props} /> */}
      <>
