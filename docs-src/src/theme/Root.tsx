...
function addCallToActionButton() {
    ...
    const callToActions = [
        {
            text: 'Follow',
            keyword: '@twitter',
            url: 'https://twitter.com/intent/user?screen_name=nxdbjs',
            icon: '🐦'
        },
        {
            text: 'Follow',
            keyword: '@LinkedIn',
            url: 'https://www.linkedin.com/company/nxdb',
            icon: '[in]'
        },
        {
            text: 'Chat',
            keyword: '@discord',
            url: 'https://nxpkg.github.io/nxdb/chat',
            icon: '💬'
        },
        {
            text: 'Star',
            keyword: '@github',
            url: 'https://nxpkg.github.io/nxdb/code',
            icon: '🐙💻'
        },
        {
            text: 'Subscribe',
            keyword: '@newsletter',
            url: 'https://nxpkg.github.io/nxdb/newsletter',
            icon: '📰'
        },
        {
            text: 'Take Part in the',
            keyword: 'User Survey 2024',
            url: 'https://nxpkg.github.io/nxdb/survey',
            icon: '📝'
        }
    ];
    ...
    const callToActionButtonId = 'nxdb-call-to-action-button';
...
/**
 * There are some logs that NxDB prints out to the console of the developers.
 * These logs can contain links with the query param ?console=foobar
 * which allows us to detect that a user has really installed and started NxDB.
 */
