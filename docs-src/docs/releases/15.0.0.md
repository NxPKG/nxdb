...
The release [15.0.0](https://nxdb.khulnasoft.com/releases/15.0.0.html) is used for major refactorings in the migration plugins and performance improvements of the RxStorage implementations.
...
The NxDB test suite now also runs in the [deno](https://deno.com/) runtime. Also there is a [DenoKV](https://nxdb.khulnasoft.com/rx-storage-denokv.html) based RxStorage to use with Deno Deploy.
