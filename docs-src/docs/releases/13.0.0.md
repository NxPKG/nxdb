...
- REFACTORED the [schema validation plugins](https://nxdb.khulnasoft.com/schema-validation.html), they are no longer plugins but now they get wrapped around any other RxStorage.
