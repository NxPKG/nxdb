...
- REFACTORED the [schema validation plugins](https://nxpkg.github.io/nxdb/schema-validation.html), they are no longer plugins but now they get wrapped around any other RxStorage.
