...
Please always ensure that your pouchdb adapter-version is the same as `pouchdb-core` in the [nxdb package.json](https://github.com/nxpkg/nxdb/blob/master/package.json). Otherwise, you might have strange problems.
...
## Memdown
With NxDB you can also use adapters that implement [abstract-leveldown](https://github.com/Level/abstract-leveldown) like the memdown-adapter.
...
import { addPouchPlugin, getRxStoragePouch } from 'nxdb/plugins/pouchdb';
...
:::note
There are [known problems](https://github.com/nxpkg/nxdb/issues/2286) with this adapter and it is **not** recommended to use it.
:::
