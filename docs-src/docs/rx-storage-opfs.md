...
With the [NxDB](https://nxpkg.github.io/) OPFS storage you can build a fully featured database on top of the [Origin Private File System](https://web.dev/opfs) (OPFS) browser API. Compared to other storage solutions, it has a way better performance.
...
- [Performance Test Tool](https://nxpkg.github.io/client-side-databases/database-comparison/index.html)
