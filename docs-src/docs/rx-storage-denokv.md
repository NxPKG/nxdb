...
With the DenoKV [RxStorage](./rx-storage.md) layer for [NxDB](https://nxpkg.github.io), you can run a fully featured **NoSQL database** on top of the [DenoKV API](https://docs.deno.com/kv/manual).
