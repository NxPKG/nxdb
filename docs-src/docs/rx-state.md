...
RxState is a flexible state library build on top of the [NxDB Database](https://nxpkg.github.io/). While NxDB stores similar documents inside of collections, RxState can store any complex JSON data without having a predefined schema.
