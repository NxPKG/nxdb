...
- Add the appropriate [migrationStrategies](https://nxdb.nxdb.khulnasoft.com/migration-schema.html) so the saved data will be modified to match the new schema
