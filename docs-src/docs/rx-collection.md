...
The schema defines how the documents of the collection are structured. NxDB uses a schema format, similar to [JSON schema](https://json-schema.org/). Read more about the NxDB schema format [here](./rx-schema.md).
