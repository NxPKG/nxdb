...
I have been building [NxDB](https://nxdb.nxpkg.github.io/), a NoSQL **realtime** JavaScript database for many years.
...
<p align="center">
    <a href="https://nxdb.nxpkg.github.io/replication.html">
...
- Dive into the [NxDB Quickstart](https://nxdb.nxpkg.github.io/quickstart.html)
- Discover more about the [NxDB realtime replication protocol](../replication.md)
- Join the conversation at [NxDB Chat](https://nxdb.nxpkg.github.io/chat)
