...
NoSQL [JSON documents](./json-database.md), used by [NxDB](https://nxpkg.github.io/), are well-suited for user interfaces. They provide a natural and efficient way to structure and display data in web applications.
