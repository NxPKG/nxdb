...
With the FoundationDB based [RxStorage](./rx-storage.md) of [NxDB](https://nxpkg.github.io/) you can combine the benefits of FoundationDB while having a fully featured, high performance NoSQL database.
