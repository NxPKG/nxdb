        ...
        if (showDevModeWarning) {
            console.warn(
                [
                    ...
                    'you are seeing this because you use the NxDB dev-mode plugin https://nxdb.khulnasoft.com/dev-mode.html?console=dev-mode ',
                    ...
                    'to get access to faster storages and more professional features: https://nxdb.khulnasoft.com/premium?console=dev-mode ',
                    '',
