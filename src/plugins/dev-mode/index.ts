        ...
        if (showDevModeWarning) {
            console.warn(
                [
                    ...
                    'you are seeing this because you use the NxDB dev-mode plugin https://nxpkg.github.io/dev-mode.html?console=dev-mode ',
                    ...
                    'to get access to faster storages and more professional features: https://nxpkg.github.io/premium?console=dev-mode ',
                    '',
