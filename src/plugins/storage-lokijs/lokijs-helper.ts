...
export const CHANGES_COLLECTION_SUFFIX = '-nxdb-changes';
export const LOKI_BROADCAST_CHANNEL_MESSAGE_TYPE = 'nxdb-lokijs-remote-request';
export const LOKI_KEY_OBJECT_BROADCAST_CHANNEL_MESSAGE_TYPE = 'nxdb-lokijs-remote-request-key-object';
