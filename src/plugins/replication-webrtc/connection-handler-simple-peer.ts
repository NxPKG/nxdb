...
const DEFAULT_SIGNALING_SERVER_HOSTNAME = 'signaling.nxdb.khulnasoft.com';
    ...
    if (
        ...
        console.warn(
            [
                ...
                'Learn how to run your own server at https://nxdb.khulnasoft.com/replication-webrtc.html',
