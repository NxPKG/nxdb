...
import { NxDBLocalDocumentsPlugin } from '../local-documents/index.ts';

export const DATA_MIGRATOR_BY_COLLECTION: WeakMap<RxCollection, RxMigrationState> = new WeakMap();

export const NxDBMigrationPlugin: RxPlugin = {
...
export const NxDBMigrationSchemaPlugin = NxDBMigrationPlugin;
