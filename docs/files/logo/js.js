...
async function getTextPaths() {
    ...
    const paths = font.getPaths('NxDB', 200, (blockSize * 13) + 1.7, 79.1, {});
    console.log('paths:');
    console.dir(paths);
...
async function getMiniTextPaths() {
    ...
    const paths = font.getPaths('NxDB', 205, (blockSize * 16) + 1.7, 160, {});
    console.log('paths:');
    console.dir(paths);
...
async function getSubtextPathBlocks() {
    ...
    const fontSize = 93.2;
    const xPosition = 205;
    const paths1 = font.getPaths('NxDB', xPosition, (blockSize * 10) + 18, fontSize, {});
