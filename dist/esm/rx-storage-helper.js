...
import { PROMISE_RESOLVE_TRUE, NXDB_VERSION, RX_META_LWT_MINIMUM, appendToArray, createRevision, ensureNotFalsy, flatClone, getDefaultRevision, getDefaultRxDocumentMeta, lastOfArray, now, promiseWait, randomCouchString } from "./plugins/utils/index.js";
...
export var INTERNAL_STORAGE_NAME = '_nxdb_internal';
...
rxJsonSchema) {
  ...
  var ret = {
    ...
    bulkWrite(rows, context) {
       ...
       * But for better developer experience, NxDB does allow to re-insert deleted documents.
       * We do this by automatically fixing the conflict errors for that case
       * by running another bulkWrite() and merging the results.
       * @link https://github.com/nxpkg/nxdb/pull/3839
       */.then(writeResult => {
        var useWriteResult = {
          error: []
        };
