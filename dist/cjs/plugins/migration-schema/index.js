...
var _exportNames = {
  ...
  NxDBMigrationPlugin: true,
  NxDBMigrationSchemaPlugin: true
};
exports.NxDBMigrationSchemaPlugin = exports.NxDBMigrationPlugin = exports.DATA_MIGRATOR_BY_COLLECTION = void 0;
...
var NxDBMigrationPlugin = exports.NxDBMigrationPlugin = {
  name: 'migration-schema',
  nxdb: true,
  init() {
    (0, _plugin.addRxPlugin)(_index2.NxDBLocalDocumentsPlugin);
  },
  hooks: {
...
var NxDBMigrationSchemaPlugin = exports.NxDBMigrationSchemaPlugin = NxDBMigrationPlugin;
