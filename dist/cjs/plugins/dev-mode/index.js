...
var _exportNames = {
  ...
  NxDBDevModePlugin: true
};
exports.NxDBDevModePlugin = exports.DEV_MODE_PLUGIN_NAME = void 0;
...
var NxDBDevModePlugin = exports.NxDBDevModePlugin = {
  name: DEV_MODE_PLUGIN_NAME,
  nxdb: true,
  init: () => {
    if (showDevModeWarning) {
      console.warn(['-------------- NxDB dev-mode warning -------------------------------', 'you are seeing this because you use the NxDB dev-mode plugin https://nxpkg.github.io/dev-mode.html?console=dev-mode ', 'This is great in development mode, because it will run many checks to ensure', 'that you use NxDB correct. If you see this in production mode,', 'you did something wrong because the dev-mode plugin will decrease the performance.', '', '🤗 Hint: To get the most out of NxDB, check out the Premium Plugins', 'to get access to faster storages and more professional features: https://nxpkg.github.io/premium?console=dev-mode ', '', 'You can disable this warning by calling disableWarnings() from the dev-mode plugin.',
      // '',
      // 'Also take part in the NxDB User Survey: https://nxpkg.github.io/survey.html',
      '---------------------------------------------------------------------'].join('\n'));
    }
  },
  overwritable: {
