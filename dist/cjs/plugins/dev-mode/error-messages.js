...
var ERROR_MESSAGES = exports.ERROR_MESSAGES = {
  ...
  // plugins
  PL1: 'Given plugin is not NxDB plugin.',
  // removed in 14.0.0 - PouchDB RxStorage was removed - PL2: 'You tried importing a NxDB plugin to pouchdb. Use addRxPlugin() instead.',
  ...
  DB6: 'RxDatabase.addCollections(): another instance created this collection with a different schema. Read this https://nxdb.nxpkg.github.io/questions-answers.html?console=qa#cant-change-the-schema ',
  ...
  DM5: 'Cannot open database state with newer NxDB version. You have to migrate your database state first. See https://nxdb.nxpkg.github.io/migration-storage.html?console=storage ',
  ...
  RC7: 'SimplePeer requires to have process.nextTick() polyfilled, see https://nxdb.nxpkg.github.io/replication-webrtc.html?console=webrtc ',
  ...
  SC40: '$ref fields in the schema are not allowed. NxDB cannot resolve related schemas because it would have a negative performance impact.' + 'It would have to run http requests on runtime. $ref fields should be resolved during build time.',
  ...
  // removed in 15.0.0, added boolean index support to dexie storage - DXE1: 'The dexie.js RxStorage does not support boolean indexes, see https://nxdb.nxpkg.github.io/rx-storage-dexie.html#boolean-index',
