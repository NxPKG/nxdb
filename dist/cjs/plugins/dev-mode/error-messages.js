...
var ERROR_MESSAGES = exports.ERROR_MESSAGES = {
  ...
  DB6: 'RxDatabase.addCollections(): another instance created this collection with a different schema. Read this https://nxdb.khulnasoft.com/questions-answers.html?console=qa#cant-change-the-schema ',
  ...
  DM5: 'Cannot open database state with newer NxDB version. You have to migrate your database state first. See https://nxdb.khulnasoft.com/migration-storage.html?console=storage ',
  ...
  RC7: 'SimplePeer requires to have process.nextTick() polyfilled, see https://nxdb.khulnasoft.com/replication-webrtc.html?console=webrtc ',
  ...
  // removed in 15.0.0, added boolean index support to dexie storage - DXE1: 'The dexie.js RxStorage does not support boolean indexes, see https://nxdb.khulnasoft.com/rx-storage-dexie.html#boolean-index',
