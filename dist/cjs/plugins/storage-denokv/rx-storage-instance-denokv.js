...
var RxStorageInstanceDenoKV = exports.RxStorageInstanceDenoKV = /*#__PURE__*/function () {
  function RxStorageInstanceDenoKV(storage, databaseName, collectionName, schema, internals, options, settings, keySpace = ['nxdb', databaseName, collectionName, schema.version].join('|'), kvOptions = {
   ...
   * which would confuse NxDB and return wrong query results.
   */
