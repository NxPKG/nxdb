...
export declare const CHANGES_COLLECTION_SUFFIX = "-nxdb-changes";
export declare const LOKI_BROADCAST_CHANNEL_MESSAGE_TYPE = "nxdb-lokijs-remote-request";
export declare const LOKI_KEY_OBJECT_BROADCAST_CHANNEL_MESSAGE_TYPE = "nxdb-lokijs-remote-request-key-object";
