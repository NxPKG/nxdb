...
> = {
     ...
     * NxDB will internally prepend the _deleted field to the index
     ...
     * by NxDB. Use these to speed up queries that are run manually on the storage
     * or to speed up requests when you use the NxDB server.
    ...
    /**
     * if not set, nxdb will set 'false' as default
     ...
     * @link https://nxpkg.github.io/nxdb/rx-storage-sharding.html
     */
    sharding?: {
        /**
         * Amount of shards.
 ...
 * @link https://github.com/nxpkg/nxdb/discussions/3467
 */
